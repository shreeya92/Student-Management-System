...
if(isset($_POST) && !empty($_POST)) {
    if($_POST["submit"]== "Submit"){
        ...
        if(empty($_POST['confirm_password'])){
         ...
         if(!empty($error)){
            ...
            header('location:registrationforteacher.php');
         }else{
            ...
            $sql = "INSERT INTO teacher (username, email, address,  dob, gender, contact, password) VALUES ('$username', '$email', '$address', '$dob', '$gender', '$contact',
             '$password')";
    ...
    echo"<a href='registrationforteacher.php'>Please Register First </a>";
}
// session_destroy();
?>